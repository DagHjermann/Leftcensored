...
'
  } else if (bs == "tp" & k_code == 5 & type == "leftcensored"){
...
'
  ...
  } else if (bs == "tp" & k_code == 6 & type == "leftcensored"){
...
'
  ...
  } else if (bs == "tp" & k_code == 7 & type == "leftcensored"){
...
'
  ...
  } else if (bs == "tp" & k_code == 8 & type == "leftcensored"){
...
'
  ...
  } else if (bs == "tp" & k_code == 5 & type == "leftcensored_measerror"){
...
'
  ...
  } else if (bs == "tp" & k_code == 6 & type == "leftcensored_measerror"){
...
'
  } else if (bs == "tp" & k_code == 7 & type == "leftcensored_measerror"){
...
'
  } else if (bs == "tp" & k_code == 8 & type == "leftcensored_measerror"){
